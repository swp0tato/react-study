...
- 유저는 현재 위치 기반으로 주변 카페 리스트를 볼 수 있습니다.<br>
- 유저는 지도에서 현재 위치를 확인할 수 있습니다.(노란색 마커)<br>
- 유저는 입력한 키워드와 관련된 카페 리스트를 볼 수 있습니다.<br>
- 유저는 검색 데이터 확인 후, 현재 위치 버튼을 클릭하면 다시 현재 위치 기반의 주변 카페를 볼 수 있습니다.<br>
- 결과(카페) 데이터 목록에 마우스를 올려두면(hover) 지도에서 해당 카페로 이동합니다.<br>
...
- 유저는 결과(카페) 데이터를 정확도, 가까운 순으로 정렬하여 볼 수 있습니다.<br>
...
- 지도에서 각각의 카페 마커를 클릭하면 해당 카페의 정보가 뜨고, 해당 카페 위치로 이동합니다.<br>
  (홈페이지 링크를 클릭하면 해당 카페 정보를 확인할 수 있습니다.)<br>
- 결과(카페) 데이터 목록을 클릭하면 디테일(상세) 페이지로 이동합니다.<br>
